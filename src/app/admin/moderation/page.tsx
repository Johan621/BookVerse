...
export default function ModerationQueuePage() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <DataTable data={moderationQueue} // eslint-disable-next-line @typescript-eslint/no-explicit-any
      columns={columns as any} searchPlaceholder="Search by title or reporter..." />
    </div>
  );
}
